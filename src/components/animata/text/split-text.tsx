...
export default function SplitText({ text = "SOUHAIL" , className }: { text: string , className : string }) {
  ...
  return (
    <div className={`relative mx-auto cursor-sword text-[50px] sm:text-[80px] lg:text-[100px] xl:text-[130px] font-black uppercase text-yellow-500 ${className}`}>
